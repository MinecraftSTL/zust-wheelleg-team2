...
#define DEBUG_UART_INDEX            (UART_10)            // 指定 debug uart 所使用的的串口
#define DEBUG_UART_BAUDRATE         (115200)            // 指定 debug uart 所使用的的串口波特率
#define DEBUG_UART_TX_PIN           (UART10_TX_P13_0)    // 指定 debug uart 所使用的的串口引脚
#define DEBUG_UART_RX_PIN           (UART10_RX_P13_1)    // 指定 debug uart 所使用的的串口引脚
