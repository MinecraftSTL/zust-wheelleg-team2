    ...
    switch(cameraStatus){
        ...
        case TI_LCIRCLE:
            ...
            *cameraV = circleV;
            ...
            float tempY = lll((float)Encoder_speed, circleV, bendV, circleErrY, bendErrY);
            *cameraY = (uint16)func_limit_ab(tempY, circleErrY, bendErrY);
            break;
        case R_LCIRCLE:
...
//            *cameraV = circleV;、
            ...
            tempY = lll((float)Encoder_speed, circleV, bendV, circleErrY, bendErrY);
            *cameraY = (uint16)func_limit_ab(tempY, circleErrY, bendErrY);
            break;
        case TO_LCIRCLE:
