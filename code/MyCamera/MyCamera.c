...
void Image_circle(Image *this, uint8 dir){
    ...
    switch(cameraStatus){
        ...
        case PTL_LCIRCLE:
            ...
            if(lInfN > 0){
                Image_borderSetCLine(this, lBorder, lLine[lInfLine[0]][0], lLine[lInfLine[0]][1], 0, this->h-1);
            }
            break;
        case TL_LCIRCLE:
