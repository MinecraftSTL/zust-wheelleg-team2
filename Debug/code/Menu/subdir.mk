...
clean-code-2f-menu:
	-$(RM) ./code/menu/Genshin.d ./code/menu/Genshin.o ./code/menu/Genshin.src ./code/menu/Menu.d ./code/menu/Menu.o ./code/menu/Menu.src ./code/menu/PidPage.d ./code/menu/PidPage.o ./code/menu/PidPage.src
